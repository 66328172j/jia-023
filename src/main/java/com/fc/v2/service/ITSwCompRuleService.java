...
/**
 * 补偿费减免比例判定规则 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITSwCompRuleService {

    /** 按主键查询规则 */
    TSwCompRule selectTSwCompRuleById(Long id);
    ...
    List<TSwCompRule> listAvailable(Date at);
