...
/**
 * 土壤侵蚀强度判定规则 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITSwErodeRuleService {

    /** 按主键查询规则 */
    TSwErodeRule selectTSwErodeRuleById(Long id);
    ...
    List<TSwErodeRule> listAvailable(Date at);
