...
/**
 * 监测频次风险判定规则 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITSwMoniRuleService {

    /** 按主键查询规则 */
    TSwMoniRule selectTSwMoniRuleById(Long id);
    ...
    List<TSwMoniRule> listAvailable(Date at);
