...
/**
 * 自主验收报备签批单对象 t_sw_accept_bill
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_sw_accept_bill")
@ApiModel(value = "TSwAcceptBill", description = "自主验收报备签批单")
public class TSwAcceptBill implements Serializable {
