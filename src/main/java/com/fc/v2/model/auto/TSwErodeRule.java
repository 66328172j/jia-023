...
/**
 * 土壤侵蚀强度判定规则对象 t_sw_erode_rule
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_sw_erode_rule")
@ApiModel(value = "TSwErodeRule", description = "土壤侵蚀强度判定规则")
public class TSwErodeRule implements Serializable {
    ...
    /** 侵蚀微度档上限(t/km2·a) */
    @TableField("th1_max")
    @ApiModelProperty(value = "侵蚀微度档上限(t/km2·a)")
    private BigDecimal th1Max;

    /** 侵蚀轻度档上限(t/km2·a) */
    @TableField("th2_max")
    @ApiModelProperty(value = "侵蚀轻度档上限(t/km2·a)")
    private BigDecimal th2Max;

    /** 侵蚀中度档上限(t/km2·a) */
    @TableField("th3_max")
    @ApiModelProperty(value = "侵蚀中度档上限(t/km2·a)")
