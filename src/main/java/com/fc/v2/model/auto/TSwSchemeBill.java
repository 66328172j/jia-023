...
/**
 * 水保方案签批单对象 t_sw_scheme_bill
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_sw_scheme_bill")
@ApiModel(value = "TSwSchemeBill", description = "水保方案签批单")
public class TSwSchemeBill implements Serializable {
