...
/**
 * 补偿费减免比例判定规则对象 t_sw_comp_rule
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_sw_comp_rule")
@ApiModel(value = "TSwCompRule", description = "补偿费减免比例判定规则")
public class TSwCompRule implements Serializable {
    ...
    /** 减免一档上限(%) */
    @TableField("th1_max")
    @ApiModelProperty(value = "减免一档上限(%)")
    private BigDecimal th1Max;

    /** 减免二档上限(%) */
    @TableField("th2_max")
    @ApiModelProperty(value = "减免二档上限(%)")
    private BigDecimal th2Max;

    /** 减免三档上限(%) */
    @TableField("th3_max")
    @ApiModelProperty(value = "减免三档上限(%)")
