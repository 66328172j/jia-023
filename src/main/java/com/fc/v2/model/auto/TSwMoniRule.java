...
/**
 * 监测频次风险判定规则对象 t_sw_moni_rule
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_sw_moni_rule")
@ApiModel(value = "TSwMoniRule", description = "监测频次风险判定规则")
public class TSwMoniRule implements Serializable {
    ...
    /** 风险低档上限 */
    @TableField("th1_max")
    @ApiModelProperty(value = "风险低档上限")
    private BigDecimal th1Max;

    /** 风险中档上限 */
    @TableField("th2_max")
    @ApiModelProperty(value = "风险中档上限")
    private BigDecimal th2Max;

    /** 风险高档上限 */
    @TableField("th3_max")
    @ApiModelProperty(value = "风险高档上限")
